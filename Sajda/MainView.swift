        ...
        VStack(alignment: .leading, spacing: 6) {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Button(action: {
                    ...
                    HStack { Text(LocalizedStringKey("Settings")); Spacer(); Image(systemName: "chevron.right").font(.caption.weight(.bold)).foregroundColor(.secondary) }
                ...
                Button(action: {
                    ...
                    HStack { Text(LocalizedStringKey("About")); Spacer(); Image(systemName: "chevron.right").font(.caption.weight(.bold)).foregroundColor(.secondary) }
                        .padding(.vertical, 5).padding(.horizontal, 8)
                ...
                Button(action: { NSApp.terminate(nil) }) {
                    HStack { Text(LocalizedStringKey("Quit")); Spacer() }
                        .padding(.vertical, 5).padding(.horizontal, 8)
